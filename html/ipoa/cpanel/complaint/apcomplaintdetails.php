		...
		for($x=0;$x<sizeof($temp);$x++)
		{
			...
			if($rs1)
			{
				...
				if ($counts1>0)
				{
					...
					{
					$div=$div."<div style=\"float:left;position:relative;\" ><a class=\"flink\" href=\"viewpersons.php?url=apcomplaintdetails&personsid=$datap[0]&complaintid=$datax[0]&sessid=smetsysmocmas&index=$index\"><div id=\"persons\" class=\"persons\" style=\" border: thin solid #7Ba89A; margin-left:20px;margin-top:2px;margin-bottom:2px;  padding-top:3px; padding-bottom:3px; padding-left:10px; padding-right:5px;\">$datap[2]. $datap[3] $datap[4] $datap[5] $onbehalfname</div></a></div>";
					}
				}
			}
		}
...
-->
 ...
 <table style="margin-left:15px;"  width="644" border="0" cellpadding="0" cellspacing="0" class="Black_Header_Text">
  ...
  <tr>
    <td height="22" colspan="2" valign="top">Approved  complaints details (Editing not possible) </td>
    <td colspan="3" valign="top"><div align="right" style="font-size:20px;"><?php echo "Complaint file N<u>o</u>: ".@$datax[0];?></div></td>
    </tr>
  <tr>
  ...
  <tr>
    ...
    <td colspan="2" valign="top"><div align="right">
      <input name="btnClose" type="button" class="BTN" id="cmdClose" value="Close" onclick="getPage('<?php $url1=@$_GET['url1']; if($url1==""){echo "apcomplaint.php";}else{echo "../reports/$url1.php";}?>','content','index=<?php echo @$index; ?>&status=<?php echo @$status; ?>')" />
    </div></td>
  </tr>
  <tr>
    ...
    <td width="86" rowspan="2" valign="top"><?php echo getUrgent($pref,$datax[0],25,60);?></td>
  </tr>
  <tr>
    <td height="6"></td>
    <td width="421"></td>
