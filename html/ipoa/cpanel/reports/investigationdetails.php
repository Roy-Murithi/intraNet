...
-->
 ...
 <table style="margin-left:15px;"  width="644" border="0" cellpadding="0" cellspacing="0" class="Black_Header_Text">
  ...
  <tr>
    ...
    <td colspan="4" valign="top"><div align="right" style="font-size:20px;"><?php $valDat=fetchValue($pref."investigation","complaintid",$complaintid,0);echo "Investigation file N<u>o</u>: ".@$valDat;?>
    </div></td>
  </tr>
  <tr>
    <td height="13" colspan="6" valign="top"><img src="../images/phead.png" width="700" height="5" /></td>
  </tr>
  <tr>
    <td height="22" colspan="4" valign="top">Complaint</td>
    <td width="9">&nbsp;</td>
  ...
  <tr>
    ...
    <td colspan="3" valign="top"><div align="right">
      <input name="btnClose" type="button" class="BTN" id="cmdClose" value="Close" onclick="getPage('<?php $url1=@$_GET['url1']; if($url1==""){echo "investigation.php";}else{echo "$url1.php";}?>','content','index=<?php echo @$index; ?>&status=<?php echo @$status; ?>')" />
    </div></td>
  </tr>
  ...
  <tr>
    <td height="6" colspan="6" valign="top"><img src="../images/phead.png" width="700" height="5" /></td>
    </tr>
</table>
