...
<table width="784" border="0" cellpadding="0" cellspacing="0" class="Black_Header_Text">
  ...
  <tr>
    <td height="34"></td>
    <td></td>
    <td valign="top"><input name="button4"   type="button" class="BTN" id="button4" value="Gender report"  onclick="window.open('report8.php?date1='+document.frmUsers.date1.value+'&amp;date2='+document.frmUsers.date2.value)"/></td>
    <td></td>
    <td></td>
  </tr>
  <tr>
