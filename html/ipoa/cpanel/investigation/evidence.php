...
<table width="739" border="0" cellpadding="0" cellspacing="0" class="Black_Header_Text">
  ...
  <tr>
	...
	<textarea name="txtDat1" class="STR1" id="txtDat1" ></textarea>
	  ...
	  <input name="investigationid" type="hidden" id="investigationid"  value="<?php $valDat=fetchValue($pref."investigation","complaintid",@$complaintid,0);echo @$valDat; ?>"/>
	  </td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  ...
  <tr>
	...
	?></td>
    <td valign="top"><input name="Button2" type="button" class="BTN" value="Cancel" style="width:100px;" onclick="getPage('myinvestigationdetails.php','content','index=<?php echo $index;?>&complaintid=<?php echo $complaintid;?>')"  /></td>
    <td></td>
    <td></td>
  </tr>
</table>
