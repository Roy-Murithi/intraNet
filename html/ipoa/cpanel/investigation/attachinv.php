...
<table width="794" class="Black_Header_Text" style="margin-left:5px;">
	      <!--DWLayoutTable-->
            <tr>
              ...
              <td colspan="4" valign="top"><div align="right"> <form name="frmSearch" enctype="multipart/form-data" method="get" style="width:300px;"  action="attachinv.php">Search: <input type="text" class="STR1" name="txtSearch" value="<?php echo @$_GET['txtSearch'];?>" /><input type="submit" name="btnSearch" class="BTN" value="Search" />
  ...
  <tr>
		...
		if($rs)
		{
			...
			if ($counts>0)
			{
				...
				{
					$btn="<input id=\"btn$x\"  type=\"button\" onclick=\"getPage('saveattachinv.php','content','invid=$data[0]&index=$index&complaintid=$complaintid')\" value=\"Attach support investigator\" class=\"BTN\">";
				}
