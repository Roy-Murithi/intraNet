		...
		for($x=0;$x<sizeof($temp);$x++)
		{
			...
			if($rs1)
			{
				...
				if ($counts1>0)
				{
					...
					{
					$div=$div."<div style=\"float:left;position:relative;\" ><a class=\"flink\" href=\"viewpersons.php?url=asscomplaintdetails&personsid=$datap[0]&complaintid=$datax[0]&sessid=smetsysmocmas&index=$index\"><div id=\"persons\" class=\"persons\" style=\" border: thin solid #7Ba89A; margin-left:20px;margin-top:2px;margin-bottom:2px;  padding-top:3px; padding-bottom:3px; padding-left:10px; padding-right:5px;\">$datap[2]. $datap[3] $datap[4] $datap[5] $onbehalfnam</div></a></div>";
					}
				}
			}
		}
...
-->
 ...
 <table style="margin-left:15px;"  width="644" border="0" cellpadding="0" cellspacing="0" class="Black_Header_Text">
  ...
  <tr>
    ...
    <td colspan="3" valign="top"><div align="right" style="font-size:20px;"><?php $valDat=fetchValue($pref."investigation","complaintid",$complaintid,0);echo "Investigation file N<u>o</u>: ".@$valDat;?>
    </div></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td width="123" valign="top"><!--DWLayoutEmptyCell-->&nbsp;</td>
  </tr>
  <tr>
    <td width="15" height="53"></td>
    <td colspan="4" valign="top" style="background-color:#ABD8DA; border: thin solid #7Ba89A"><?php $assignment=fetchValue($pref."investigation","complaintid",$complaintid,14);
					if($assignment!="" && $assignment!="-")
					{
			
						$assgnmt="<div style=\"border:thin dotted #008800;margin:2px;padding:2px;\"><font color=\"#008800\">Investiogation assignment instruction<br />Instruction: $assignment</font></div> ";
					}else
					{
						$assgnmt="";
					}
  ...
  <tr>
    ...
    <td></td>
    <td></td>
    <td colspan="2" valign="top"><div align="right"><?php if(@$datax[17]!="94" && @$datax[17]!="93"){?>
      <input name="btnClose" type="button" class="BTN" id="cmdClose" value="Conclude Investigation" onclick="getPage('saveconclude.php','content','index=<?php echo @$index;?>&sessid=smetsysmocmas&complaintid=<?php echo @$complaintid;?>')" /><?php } ?>
    </div></td>
  </tr>
...
<div id="canvas2" style="width:700px;">
	...
	<div id="investigations" >
		 <table style="margin-left:15px;"  width="700" border="0" cellpadding="0" cellspacing="0" class="Black_Header_Text">
		  <!--DWLayoutTable-->
		  ...
		  <tr>
		    ...
		    <td width="4">&nbsp;</td>
		    <td width="521" rowspan="2" valign="top" style="background-color:#ABD8DA; border: thin solid #7Ba89A"><?php 
	...
	if($rs1)
	{
		...
		if ($counts1>0)
		{
			...
			echo @$data[4]; ?></td>
		    <td width="56" rowspan="2" valign="top"><?php
		$script="getPage('editinv.php','content','complaintid=$complaintid&sessid=smetsysmocmas&action=0&index=$index')"; 
		echo classBTN("btnApprove","<img src=\"../images/ico_edit.png\">","#","","$script"); 
		$script="getPage('editinv.php','content','complaintid=$complaintid&sessid=smetsysmocmas&action=0&index=$index&del=99')"; 
		echo classBTN("btnApprove","<img src=\"../images/ico_drop.png\">","#","","$script");
		?></td>
		  </tr>
		  <tr>
			<td height="13"></td>
		...
		$script="getPage('editinv.php','content','complaintid=$complaintid&sessid=smetsysmocmas&action=1&index=$index')"; 
		echo classBTN("btnApprove","<img src=\"../images/ico_edit.png\">","#","","$script"); 
		$script="getPage('editinv.php','content','complaintid=$complaintid&sessid=smetsysmocmas&action=1&index=$index&del=99')"; 
		echo classBTN("btnApprove","<img src=\"../images/ico_drop.png\">","#","","$script");
		?></td>
		  </tr>
		  ...
		  <tr>
	        ...
	        <td rowspan="2" valign="top"><?php
		$script="getPage('editinv.php','content','complaintid=$complaintid&sessid=smetsysmocmas&action=2&index=$index')"; 
		echo classBTN("btnApprove","<img src=\"../images/ico_edit.png\">","#","","$script"); 
		$script="getPage('editinv.php','content','complaintid=$complaintid&sessid=smetsysmocmas&action=2&index=$index&del=99')"; 
		echo classBTN("btnApprove","<img src=\"../images/ico_drop.png\">","#","","$script");
		?></td>
	      </tr>
		  ...
		  <tr>
		    ...
		    <td rowspan="2" valign="top"><?php
		$script="getPage('editinv.php','content','complaintid=$complaintid&sessid=smetsysmocmas&action=3&index=$index')"; 
		echo classBTN("btnApprove","<img src=\"../images/ico_edit.png\">","#","","$script"); 
		$script="getPage('editinv.php','content','complaintid=$complaintid&sessid=smetsysmocmas&action=3&index=$index&del=99')"; 
		echo classBTN("btnApprove","<img src=\"../images/ico_drop.png\">","#","","$script");
		?></td>
		  </tr>
		  <tr>
		  ...
		  <tr>
			...
			if($rs)
			{
				...
				if ($counts>0)
				{
					...
					echo getEvidence1($pref,$dataz,$index); ?>&nbsp;<?php echo getAddE($datax,$index); 
				}
			}?>
			</td>
		    <td></td>
