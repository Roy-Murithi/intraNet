...
$field=12;
	...
	$value=fetchValue($pref."investigation","complaintid",$complaintid,$field);
...
<script language="javascript">
	...
	getPage("mycomplaintdetails.php","content","index=<?php echo $index;?>&complaintid=<?php echo $complaintid;?>&sessid=smetsysmocmas");
</script>
</html>
