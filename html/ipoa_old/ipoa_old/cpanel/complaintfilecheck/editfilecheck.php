...
$index=@$_GET["index"];
$cfilecheckid=@$_GET["cfilecheckid"];

if($cfilecheckid!="")
{
		$rs=@mysql_query("select * from ".$pref."cfilecheck where `cfilecheckid`='$cfilecheckid'");
		if($rs)
		{
...
<input type="hidden" name="cfilecheckid" value="<?php echo @$datax[0];?>" />
