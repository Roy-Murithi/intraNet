...
else
{
	...
	$query="insert into  ".$pref."persons values('$personsidx','$dat1','$dat2','$dat3','$dat4','$dat5','$dat6','$dat7','$dat8','$dat9','$dat10','$dat11','$dat12','$dat13','$dat14','$dat15','$dat16','$dat17','$dat18','none','0')";
	$rs=@mysql_query($query);
	if ($_FILES['txtDat19']['name']!="")
	{
		//save picture
...
<script language="javascript">
	...
	getPage("contact.php","content","index=<?php echo $index;?>&complaintid=<?php echo $complaintid;?>&sessid=smetsysmocmas");
</script>
</html>
