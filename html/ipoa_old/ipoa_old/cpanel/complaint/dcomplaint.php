	  ...
	  <table width="100%" border="0" cellpadding="0" cellspacing="1" class="Black_Header_Text"  >
	    ...
	    <tr>
	      <td width="36" height="24" valign="top" style="border-bottom:thin dotted;"><!--DWLayoutEmptyCell-->&nbsp;</td>
            ...
            <td width="113" valign="top" style="border-bottom:thin dotted;">Refered to </td>
            <td width="103" valign="top" style="border-bottom:thin dotted;">Date Refered </td>
		...
		if($rs)
		{
			...
			if ($counts>0)
			{
				...
				for($x=$start;$x<$end;$x++)
				{
					...
					$strDur="<div style=\"border:thin dotted; background:#FCFFBC;\">it has been ".getDuration(@$strRefDate,"since complaint was Refered to <font color=\"red\">$strReffered_to</font>") ."</div>";
					echo "
