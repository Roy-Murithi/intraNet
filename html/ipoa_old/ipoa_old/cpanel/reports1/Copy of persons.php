...
<body onLoad="<?php if((int)$field==3){echo "isPolice('Yes');";}else{echo "isPolice('No');";}?>">
...
<table width="739" border="0" cellpadding="0" cellspacing="0" class="Black_Header_Text">
  ...
  <tr>
    ...
    <td valign="top">
	  ...
	  <?php if((int)$field!=3){?>
	    <input name="txtDat12" type="radio" class="STR1" id="txtDat12" value="No" <?php if((int)$field!=3){echo "checked=\"checked\"";}?>   <?php if(@$datax[12]=="No"){	echo "checked=\"checked\"";}?> onClick="isPolice('No')" /> 
      No	<?php }?></div></td>
    <td colspan="3" valign="top"><div align="left">
          <input name="txtDat12" type="radio" class="STR1" id="txtDat11" <?php if((int)$field==3){echo "checked=\"checked\"";}?>  value="Yes"  <?php if(@$datax[12]=="Yes"){	echo "checked=\"checked\"";}?>  onclick="isPolice('Yes')" /> 
      Yes</div></td>
    <td></td>
    <td></td>
    </tr>
