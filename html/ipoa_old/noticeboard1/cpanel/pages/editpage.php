...
<script type="text/javascript">
        function ShowDialog() {
            var rtvalue = window.showModalDialog("listimages.php?sessid=smetsysmocmas&pageid=<? echo @$_GET["pageid"]; ?>","","dialogHeight:600;dialogWidth:750;center:yes");
			...
			{
            	document.location="editpage.php?sessid=smetsysmocmas&pageid=<? echo @$_GET["pageid"];?>&index=<? echo @$_GET["index"];?>";
			}
        }
		function ShowDialog1() {
            var rtvalue = window.showModalDialog("listimages.php?sessid=smetsysmocmas&pageid=<? echo @$_GET["pageid"]; ?>&actions=featured","","dialogHeight:600;dialogWidth:750;center:yes");
			document.location="editpage.php?sessid=smetsysmocmas&pageid=<? echo @$_GET["pageid"];?>&index=<? echo @$_GET["index"];?>";
        }
    </script>
<link href="../css/newstyle.css" rel="stylesheet" type="text/css">
...
<table width="758" class="Black_Header_Text">
	      ...
	      <tr>
            ...
            <td width="619" rowspan="2" valign="top" ><strong>Edit Page </strong></td>
            <td width="1" rowspan="12" valign="top" class="VerticalRuler" ><!--DWLayoutEmptyCell-->&nbsp;</td>
  <td width="100" ></td>
  <td width="1"></td>
          <tr>
            <td height="21" ></td>
            <td valign="top" >page options </td>
            <td></td>
  <tr>
              <td height="15"></td>
  ...
  <tr>
    <td height="4"></td>
    <td rowspan="2" valign="top" ><input name="Submit" type="submit" class="BTN" value="<?php if(@$data[1]!=""){echo "Update page";}else{echo "Publish page";}?>" onclick="document.frmpage.submit();" style="width:80px;" /></td>
              <td></td>
  <tr>
    <td   colspan="2" rowspan="8" valign="top">
	  <form name="frmpage" method="post" action="savepage.php" enctype="multipart/form-data" style="height:457px;">
	  	<table class="Black_Header_Text"><tr><td>Title</td>
		...
		<input name="template" type="hidden" value="<?php if(@$data[4]==""){echo "pg_template1.php";}else{echo @$data[4];}?>" />
		<input name="pageid" type="hidden" value="<?php if(@$data[0]!=""){echo @$data[0];}?>" />
    </form></td>
    <td height="18"></td>
  <tr>
    <td height="15" ></td>
  ...
  <tr>
    ...
    <td></td>
  <tr>
    <td height="29" colspan="4" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="Black_Header_Text">
      <!--DWLayoutTable-->
      <tr>
        <td width="101" height="25" valign="top"><div align="right">Template:</div></td>
        <td width="6">&nbsp;</td>
        <td width="638" rowspan="2" valign="top">
		<select name="" id="" onchange="document.frmpage.template.value=this.options[this.selectedIndex].value">
		<?php
$d = dir("../../");
while (false !== ($entry = $d->read())) {
  if(strtolower(substr($entry,0,3))=="pg_")
  {  	
