...
<table width="675" border="0" cellpadding="0" cellspacing="0" class="PlainContent_Box">
  ...
  <tr>
	...
	?>	</td>
    <td width="73" >&nbsp;</td>
    <td width="150" rowspan="6" valign="top" ><img src="images/users.png" width="149" height="149"></td>
    </tr>
  <tr>
  ...
  {?>
	...
	<select name="txtLevel" onChange="getFaculty(this.value)">
	  ...
	  <option value="98" <?php if( @$datax[4]=="98"){echo "selected=\"selected\"";}?>>Faculty Administrator</option>
	  <option value="97" <?php if( @$datax[4]=="97"){echo "selected=\"selected\"";}?>>Department Administrator</option>
	  <option value="96" <?php if( @$datax[4]=="96"){echo "selected=\"selected\"";}?>>User</option>
  ...
  }else
  {
  	 if( @$datax[4]=="98")
	 {
	 	$level="Faculty Administrator";
	 }else if( @$datax[4]=="97")
	 {
	 	$level="Department Administrator";
	 }else if( @$datax[4]=="96")
	 {
	 	$level="User";
	 }else if( @$datax[4]=="95")
  ...
  <tr>
    ...
    <td width="80" rowspan="2" valign="top"><input name="button" type="button" class="BTN" value="Fetch Mac" onClick="getMac()" /></td>
    <td width="17"></td>
    <td></td>
    <td></td>
    </tr>
    ...
    <td height="46" colspan="9" valign="top">
	  <table width="100%" class="Black_Header_Text" border="0" cellspacing="0">
	    ...
	    <tr><td width="31" height="23"><!--DWLayoutEmptyCell-->&nbsp;</td>
            <td width="78" valign="top">Username</td>
            <td width="177" valign="top">Names</td>
            <td width="202" valign="top">Account type</td>
            <td width="120" valign="top">Actions</td>
          </tr>
	    <tr>
	      <td height="2"></td>
            <td></td>
			...
			if ($counts>0)
			{
				for($x=0;$x<$counts;$x++)
				{
					...
					}else
					{
						...
						{
							$acctype="Faculty Administrator";
						}else if( @$data[4]=="97")
						{
							$acctype="Department Administrator";
						}else if( @$data[4]=="96")
						{
							$acctype="User";
						}else if( @$data[4]=="95")
