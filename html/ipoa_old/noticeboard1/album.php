...
<table width="1024" border="0" cellpadding="0" cellspacing="0" style="height:100px;">
  ...
  <tr>
    <td width="218" height="109" valign="top"><span class="Black_Header_Text">
      <?php include "theme/leftsidebar.php"; ?>
    </span></td>
    <td width="12">&nbsp;</td>
    <td width="794" valign="top"><div align="left">
      <?php include "functions/gallery/album.php"; ?>
    </div></td>
    </tr>
</table>
<?php
