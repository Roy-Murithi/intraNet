...
<table width="644" border="0" cellpadding="0" cellspacing="0" class="PlainContent_Box">
  ...
  <tr>
    <td width="529" height="22" valign="top">Edit person </td>
    <td width="167" valign="top"><div align="right"><?php
		$script="";
		echo classBTN("btnReturn","Add new person","editperson.php","sessid=smetsysmocmas","$script","#FF0000"); 
		?></div></td>
    <td width="4">&nbsp;</td>
  </tr>
  <tr>
	  ...
	  <table width="100%" border="0" cellpadding="0" cellspacing="1" class="Black_Header_Text"  style="border:thin dotted">
	    ...
	    <tr>
	      <td width="36" height="24" valign="top"><!--DWLayoutEmptyCell-->&nbsp;</td>
            <td width="271" valign="top">person</td>
            <td width="189" valign="top">Department</td>
            <td width="78" valign="top">Extension</td>
		...
		if($rs)
		{
			...
			if ($counts>0)
			{
				...
				for($x=0;$x<$counts;$x++)
				{
					...
					echo "
					<tr style=\"background:$color; border-bottom:thin dotted;\"><td>".($x+1)."</td><td>$data[1]</td><td>$data[7]</td><td>$data[4]</td>
