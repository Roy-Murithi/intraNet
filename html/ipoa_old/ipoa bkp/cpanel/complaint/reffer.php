...
<table width="717" border="0" cellpadding="0" cellspacing="0" class="Black_Header_Text">
  ...
  <tr>
    ...
    <td colspan="7" valign="top">Provide explanation for reffering this complaint </td>
    <td width="17">&nbsp;</td>
  </tr>
  <tr>
    <td height="23">&nbsp;</td>
  ...
  <tr>
    <td height="24"></td>
    <td colspan="2" valign="top"><div align="right">Reffered to: </div></td>
    <td colspan="4" valign="top"><input name="txtDat2" type="text" class="STR1" id="txtDat2" /></td>
    <td></td>
    <td></td>
  </tr>
  <tr>
