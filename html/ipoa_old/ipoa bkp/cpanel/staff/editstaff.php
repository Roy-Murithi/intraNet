...
<table width="646" class="Black_Header_Text">
	      ...
	      <tr>
            ...
            <td width="628" valign="top" ><strong>Edit Investigator </strong></td>
  <tr>
              <td height="21">&nbsp;</td>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="Black_Header_Text">
      ...
      <tr>
        ...
        <td colspan="3" valign="top"><select name="txtDat7" class="STR" id="txtDat7"  onchange="getJob()">
          <option value="Undefined" <?php if(@$datax[9]=="99"){echo " selected=\"selected\"";}?>>Undefined</option>
		  <option value="0" <?php if(@$datax[9]=="0"){echo " selected=\"selected\"";}?>>Director</option>
		  <option value="1" <?php if(@$datax[9]=="1"){echo " selected=\"selected\"";}?>>Deputy Director - Investigations</option>
		  <option value="2" <?php if(@$datax[9]=="2"){echo " selected=\"selected\"";}?>>Deputy Director - Complaints</option>
		  <option value="3" <?php if(@$datax[9]=="3"){echo " selected=\"selected\"";}?>>Deputy Director - Research</option>
		  <option value="4" <?php if(@$datax[9]=="4"){echo " selected=\"selected\"";}?>>Deputy Director - Monitoring and Evaluation</option>
          <option value="5" <?php if(@$datax[9]=="5"){echo " selected=\"selected\"";}?>>Head of Complaint</option>
		  <option value="6" <?php if(@$datax[9]=="6"){echo " selected=\"selected\"";}?>>Head of Legal</option>
		  <option value="7" <?php if(@$datax[9]=="7"){echo " selected=\"selected\"";}?>>Legal Officer</option>
		  <option value="8" <?php if(@$datax[9]=="8"){echo " selected=\"selected\"";}?>>Investigator</option>	
		  <option value="9" <?php if(@$datax[9]=="9"){echo " selected=\"selected\"";}?>>Complaints Officer</option>
		  <option value="10" <?php if(@$datax[9]=="10"){echo " selected=\"selected\"";}?>>Complaints Committee</option>		  
        </select>
          </td>
        <td width="183">&nbsp;</td>
      </tr>
