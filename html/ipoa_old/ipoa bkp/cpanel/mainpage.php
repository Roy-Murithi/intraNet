  ...
  <!--DWLayoutTable-->
   <tr>
	...
	<div align="left"><strong>Main Controls</strong></div>	<div class="style3 Blue_Header_Text"  >
		  ...
		  <div id="mnu1" align="left" class="style4" onclick="expandMNU('1')" >Manage Complaints</div>
		  <div id="mnucont1" style="display:none; margin-left:10px;">
			...
			<div align="left" class="subf"><a href="#"  onclick="getPage('complaint/dcomplaint.php','content','')">Reffered Complaints(<font color="#FF0000"><span id="counter7"><?php echo  fetchRecordCount($pref."complaint","uneditable",98);?></span></font>)</a></div>
		  ...
		  <div align="left" class="HorizontalRuler">&nbsp;</div>
		  <div id="mnu2" align="left" class="style4" onclick="expandMNU('2')">Investigation Management</div>
		  <div id="mnucont2" style="display:none;  margin-left:10px;">
		    ...
		    <div align="left" class="subf"><a href="#"  onclick="getPage('investigation/myinvestigation.php','content','')">My Cases</a></div>
                    <div align="left" class="subf"><a href="#"  onclick="getPage('underconstruction.php','content','')">File Audit</a></div>
		  ...
		  <div id="mnucont5" style="display:none;  margin-left:10px;">
			...
			<div align="left" class="subf"><a href="#"  onclick="getPage('underconstruction.php','content','status=4')">Monthly reports</a></div>
		  ...
		  <div align="left" class="subf"><a href="#"  onclick="getPage('investigation/filecheck.php','content','')">Setup File audit</a></div>
		  <div align="left" class="subf"><a href="#"  onclick="getPage('complaint/nature.php','content','')">Setup Complaint Nature</a></div>
		    <div align="left" class="subf"><a href="#"  onclick="getPage('dataentry/town.php','content','')">Setup Towns</a></div>
		    <div align="left" class="subf"><a href="#"  onclick="getPage('dataentry/county.php','content','')">Setup County</a></div>
		    <div align="left" class="subf"><a href="#"  onclick="getPage('dataentry/ward.php','content','')">Setup Wards</a></div>
		    <div align="left" class="esubf"><a href="#"  onclick="getPage('staff/staff.php','content','')">Invesigators</a></div>
		  </div>
		  <div align="left" class="HorizontalRuler">&nbsp;</div>
