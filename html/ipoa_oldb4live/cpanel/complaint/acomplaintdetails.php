		...
		for($x=0;$x<sizeof($temp);$x++)
		{
			...
			if($rs1)
			{
				...
				if ($counts1>0)
				{
					...
					if($datap[20]=="99")
					{
						$div=$div."<div style=\"float:left;position:relative;\" ><div id=\"persons\" class=\"persons\" style=\" border: thin solid #7Ba89A; margin-left:20px;margin-top:2px;margin-bottom:2px;  padding-top:3px; padding-bottom:3px; padding-left:10px; padding-right:5px;\">Anonymous: $datap[2]($datap[3]) </div></div>";
					}else
					{
						$div=$div."<div style=\"float:left;position:relative;\" ><a class=\"flink\" href=\"viewpersons.php?url=acomplaintdetails&personsid=$datap[0]&complaintid=$datax[0]&sessid=smetsysmocmas&index=$index\"><div id=\"persons\" class=\"persons\" style=\" border: thin solid #7Ba89A; margin-left:20px;margin-top:2px;margin-bottom:2px;  padding-top:3px; padding-bottom:3px; padding-left:10px; padding-right:5px;\">$datap[2]. $datap[3] $datap[4] $datap[5] $onbehalfname</div></a></div>";
					}
				}
			}
		}
...
-->
 ...
 <table style="margin-left:15px;"  width="701" border="0" cellpadding="0" cellspacing="0" class="Black_Header_Text">
  <!--DWLayoutTable-->

  
  
  <tr>
    <td height="22" colspan="3" valign="top">Process complaints by head/deputy director complaints</td>
  ...
  <tr>
    ...
    <td colspan="3" rowspan="2" valign="top"><?php
		$script="getPage('return.php','content','complaintid=$datax[0]&sessid=smetsysmocmas&index=$index&pid=acomplaint&pid1=acomplaintdetails&uneditableVal=0&rtitle=complaint to data entry&complaintfield=back_to_complaints')"; 
		echo classBTN1("btnReturn","Return to Complaints officers","#","","$script","#FF0000"); 
		?></td>
    <td></td>
  </tr>
  <tr>
    <td colspan="5" rowspan="2" valign="top">Complaint (<?php echo @$datax[26];?>) </td>
    <td height="18"></td>
  </tr>
  ...
  <tr>
    ...
    <td colspan="2" valign="top"><div align="right">
      <?php
		$script="getPage('saveapprove.php','content','complaintid=$datax[0]&sessid=smetsysmocmas&index=$index')"; 
		echo classBTN("btnApprove","Approve for Investigation","#","","$script"); 
		?>
    </div></td>
    <td colspan="2" valign="top"><div align="right">
      <?php
		$script="getPage('reffer.php','content','complaintid=$datax[0]&sessid=smetsysmocmas&index=$index&pid=acomplaint&pid1=acomplaintdetails&uneditableVal=98')"; 
		echo classBTN1("btnReturn","Refer Complaint","#","","$script","#FF0000"); 
		?>
    </div></td>
    <td colspan="2" valign="top">
      <div align="left">
        <?php
		$script="getPage('closecomplaint.php','content','complaintid=$datax[0]&sessid=smetsysmocmas&index=$index&pid=acomplaint&pid1=acomplaintdetails&uneditableVal=98')"; 
		echo classBTN1("btnReturn","Close complaint","#","","$script","#FF0000"); 
		?>
        </div></td><td></td>
  </tr>
  ...
  <tr>
    <td height="6" colspan="8" valign="top"><img src="../images/phead.png" width="700" height="5" /></td>
    <td></td>
  </tr>
</table>
