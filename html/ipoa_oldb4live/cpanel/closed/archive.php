...
<table width="784" border="0" cellpadding="0" cellspacing="0" class="Black_Header_Text">
  ...
  <tr>
    <td width="398" height="22" valign="top">Finalized Investigations </td>
    <td colspan="2" valign="top"><div style="float:left">Search by Case Number:
      <input name="txtSearch" type="text" id="txtSearch" value="<?php $search=@$_GET['search'];echo @$search; ?>" />
        ...
        <?php 
	  $script="getPage('archive.php','content','sessid=smetsysmocmas&index=".(int)@$_GET['index']."&search=' +document.frmUsers.txtSearch.value)";
  ...
  <tr>
    <td height="38" colspan="3" valign="top">
	  <table width="100%" border="0" cellpadding="0" cellspacing="1" class="Black_Header_Text"  >
	    <!--DWLayoutTable-->
	    <tr>
	      <td width="36" height="20" valign="top" style="border-bottom:thin dotted;">Index</td>
		...
		$rs=@mysql_query("select * from ".$pref."archive where `complaintid` like '%$search%' order by `index` desc");
