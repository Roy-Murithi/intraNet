...
-->
 ...
 <table style="margin-left:15px;"  width="644" border="0" cellpadding="0" cellspacing="0" class="Black_Header_Text">
  ...
  <tr>
    <td height="22" colspan="4" valign="top">Investigation details . Investigation assigned to 
      <?php 
	$unique_value=fetchValue($pref."investigation","complaintid",$complaintid,2);
					$inv=fetchValue("staff","staffid",$unique_value,3);
					echo "[ $inv ]";
					?></td>
    <td colspan="4" valign="top"><div align="right" style="font-size:20px;"><?php $valDat=fetchValue($pref."investigation","complaintid",$complaintid,0);echo "Investigation file N<u>o</u>: ".@$valDat;?></div></td>
    </tr>
  <tr>
    <td height="13" colspan="8" valign="top"><img src="../images/phead.png" width="700" height="5" /></td>
  </tr>
  <tr>
    <td height="22" colspan="7" valign="top">Complaint  (<?php echo @$datax[26];?>) </td>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td colspan="2" rowspan="2" valign="top" style="background-color:#ABD8DA; border: thin solid #7Ba89A"><?php 
    ...
    <td colspan="2" valign="top"><div align="left">
      <?php
		...
		$script="getPage('attachinv1.php','content','complaintid=$datax[0]&sessid=smetsysmocmas&index=$index&leadinv=99&swap=$sval');"; 
  ...
  <tr>
    ...
    <td colspan="2" valign="top"><div align="left">
      <?php
		$script="getPage('attachinv1.php','content','complaintid=$datax[0]&sessid=smetsysmocmas&index=$index&leadinv=0');"; 
