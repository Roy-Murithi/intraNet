...
<form action="savereturn1.php" method="post" enctype="multipart/form-data" name="frmUsers">
...
<table width="717" border="0" cellpadding="0" cellspacing="0" class="Black_Header_Text">
  ...
  <tr>
    ...
    <td colspan="6" valign="top">Provide instruction for the opened investigation </td>
    <td width="17">&nbsp;</td>
  </tr>
  <tr>
    <td height="23">&nbsp;</td>
  ...
  <tr>
    ...
    <td valign="top"><div align="right">
      <?php
		...
		$script="saveUser()";
		echo classBTN("btnReturn","save and open investigation","#","","$script","#FF0000"); 
		?>
    </div></td>
    <td>&nbsp;</td>
