...
<table width="844" border="0" cellpadding="0" cellspacing="0" class="PlainContent_Box">
  <!--DWLayoutTable-->

  <tr>
    <td width="529" height="22" valign="top">Edit Staff </td>
	  ...
	  <table width="100%" border="0" cellpadding="0" cellspacing="1" class="Black_Header_Text"  style="border:thin dotted">
	    ...
	    <tr>
	      <td width="36" height="24" valign="top"><!--DWLayoutEmptyCell-->&nbsp;</td>
            <td width="180" valign="top">STAFF NAME </td>
            <td width="230" valign="top">POSITION</td>
            <td width="200" valign="top">DEPARTMENT NAME</td>
            <td width="75" valign="top">EXTENSION</td> 
            <td width="112" valign="top">ACTION</td>
          </tr>
		...
		if($rs)
		{
			...
			if ($counts>0)
			{
				...
				for($x=0;$x<$counts;$x++)
				{
					...
					echo "
					<tr style=\"background:$color; border-bottom:thin dotted;\"><td>".($x+1)."</td><td>$data[1]</td><td>$data[3]</td><td>$data[7]</td><td>$data[4]</td>
					<td><a href=\"#\" onclick=\"getPage('editperson.php','content','personid=$data[0]')\">Edit</a> | <a href=\"#\" onclick=\"delPage('person.php','content','personid=$data[0]&del=99')\">Delete</a></td>
					</tr>
					";
				}
			}
