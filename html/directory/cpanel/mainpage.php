   ...
   <tr>
	...
	<div align="left"><strong>MAIN CONTROLS </strong></div>	<div class="style3 Blue_Header_Text"  >
	  ...
	  <div align="left" ><a href="#"  onclick="getPage('users.php','content','')">Users</a></div>
	      ...
	      <div id="mnu0" align="left" class="style4" onclick="expandMNU('0')" >STAFF DIRECTORY</div>
	      <div id="mnucont0" style="display:none; margin-left:10px;">
	        <div align="left" class="subf"><a href="#"  onclick="getPage('dataentry/person.php','content','')">Staff </a></div>
	        <div align="left" class="esubf"><a href="#"  onclick="getPage('dataentry/upload.php','content','')">Upload Staff</a></div>
