...
if($rs)
{
	...
	if($row>0)
	{
		...
		{		
			...
			if($data[2]==crypt($password,'IPOA.SALT')) //IPOA.SALT is the salt value used with crypt function. See https://www.functions-online.com/crypt.html
...
echo "
<script language=\"javascript\">
	alert(\"Note:Invalid username or password\");";
...
ob_end_flush(); // added to take care of "Warning: Cannot modify header information - headers already sent by..."
