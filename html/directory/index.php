...
<title> Internal Directory <?php date_default_timezone_set('Africa/Nairobi'); $y = date("Y"); print $y;?> </title>
<link href="css/newstyle.css" rel="stylesheet" type="text/css" />

<LINK REL="SHORTCUT ICON" HREF="http://intranet.ipoa.go.ke/directory/images/Ipoa_favicon.png" />
...
<form name="frmOfficers" method="get" enctype="multipart/form-data" action="index.php">
	<table width="638" border="0" cellpadding="0" cellspacing="0" class="Black_Header_Text">
	  ...
	  <tr>
		<td height="150" colspan="10" valign="top"><img name="header" src="images/header.jpg" width="700" height="150" border="0" id="header" alt="" /></td>
	  </tr>
	  ...
	  <tr>
		...
		<td width="8">&nbsp;</td>
		<td><a href="#" onclick="getPage('allstaff.php','content','')">ALL STAFF LIST</a></td>
            
        
        <td colspan="3" valign="top"><div align="right">Search officers by Name,Office,Extension or Position:</div></td>
...
/*						$strSearch="<mark>".$search."</mark>";
						...
						echo "
						<div class=\"boxed\" style=\"padding:10px; margin:10px;float:left;width:610px;\">
							 <div  style=\"width:450px;float:left\">
								...
								<div><span style=\"font-size:14px;\">Position: $data[3]</span></div>
								<div><span style=\"font-size:14px;\">Department: $data[7]</span></div>
								<div><span style=\"font-size:14px;\">Office Location: $data[5]</span></div>					
	  ...
	  <tr>
	    <td height="18"></td>
	    <td colspan="3" valign="top"><div align="right"><?php if(@$counts>0){$alpha=(int)$start+1;}else{$alpha=0;$max=0;$start=0;}echo "Displaying $alpha to ". ((int)$start + $max) ." of $counts records"; ?>
        </div></td>
	    <td></td>
	  ...
	  <tr>
		<td height="180" colspan="10" valign="top"><img src="images/tail.png" width="700" height="180" /></td>
	  </tr>
	</table>
</form>
</center>
