...
$dat22='-';
$dat23=removeTag(@$_POST["txtDat23"]);
$dat24=removeTag(@$_POST["txtDat24"]);
$onbehalf=removeTag(@$_POST["onbehalf"]);
$represented=removeTag(@$_POST["represented"]);
//$dat19="";
//$dat20="0";
...
else
{
	...
	$query="insert into  ".$pref."persons values('$personsidx','$dat1','$dat2','$dat3','$dat4','$dat5','$dat6','$dat7','$dat8','$dat9','$dat10','$dat11','$dat12','$dat13','$dat14','$dat15','$dat16','$dat17','$dat18','none','0','$dat21','$dat22','$dat23','$dat24')";
	$rs=@mysql_query($query);
	if ($_FILES['txtDat19']['name']!="")
	{
		//save picture
	...
	$personsid=$personsidx;
	if($represented!="")
	{
		$query="update  ".$pref."persons set 
		`onbehalfof`='$personsid'	
		where `personsid`='$represented'";			
		$rs=@mysql_query($query);
	}	
}
...
<script language="javascript">
	...
	{
	?>
		getPage("persons.php","content","index=<?php echo $index;?>&complaintid=<?php echo $complaintid;?>&represented=<?php echo $personsid;?>&sessid=smetsysmocmas");
	<?php
	}else
	{?>
