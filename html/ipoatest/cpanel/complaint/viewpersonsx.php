...
<table width="739" border="0" cellpadding="0" cellspacing="0" class="Black_Header_Text">
  ...
  <tr>
    ...
    <td colspan="7" valign="top">View <?php  echo $person;?> details </td>
    <td width="23">&nbsp;</td>
    </tr>
  <tr>
    <td height="23">&nbsp;</td>
  ...
  <tr>
    ...
    <td></td>
    <td colspan="3" valign="top"><?php echo @$datax[8]; ?></td>
    <td></td>
    <td></td>
    </tr>
  <tr>
  ...
  <tr>
    ...
    <td></td>
    <td colspan="3" valign="top"><?php echo @$datax[13]; ?></td>
    <td></td>
    <td></td>
    </tr>
  <tr>
    ...
    <td></td>
    <td colspan="3" valign="top"><?php echo @$datax[14]; ?></td>
    <td></td>
    <td></td>
    </tr>
  <tr>
    ...
    <td></td>
    <td colspan="3" valign="top"><?php echo @$datax[10]; ?></td>
    <td></td>
    <td></td>
    </tr>
  <tr>
    ...
    <td></td>
    <td colspan="3" valign="top"><?php echo @$datax[15]; ?></td>
    <td></td>
    <td></td>
    </tr>
<tr>
    ...
    <td></td>
    <td colspan="3" valign="top"><?php echo @$datax[24]; ?></td>
    <td></td>
    <td></td>
    </tr>
  <tr>
    ...
    <td></td>
    <td colspan="3" valign="top"><?php echo @$datax[16]; ?></td>
    <td></td>
    <td></td>
    </tr>
  <tr>
    ...
    <td></td>
    <td colspan="3" valign="top"><?php echo @$datax[17]; ?></td>
    <td></td>
    <td></td>
    </tr>
  <tr>
    ...
    <td></td>
    <td colspan="3" valign="top"><?php echo @$datax[18]; ?></td>
    <td></td>
    <td></td>
    </tr>
    <tr>
  ...
  <tr>
    ...
    <td></td>
    <td>&nbsp;</td>
    <td colspan="2" valign="top"><input name="Button2" type="button" class="BTN" value="Close" style="width:100px;" onclick="getPage('<?php echo $url; ?>','content','index=<?php echo $index;?>&complaintid=<?php echo $complaintid;?>')"  /></td>
    <td></td>
    <td></td>
  </tr>
</table>
