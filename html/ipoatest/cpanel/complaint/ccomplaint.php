...
<table width="784" border="0" cellpadding="0" cellspacing="0" class="Black_Header_Text">
  ...
  <tr>
    <td height="22" colspan="2" valign="top">Refered complaints</td>
    </tr>
  <tr>
	  ...
	  <table width="100%" border="0" cellpadding="0" cellspacing="1" class="Black_Header_Text"  >
	    ...
	    <tr>
	      <td width="36" height="24" valign="top" style="border-bottom:thin dotted;">Index</td>
            ...
            <td width="103" valign="top" style="border-bottom:thin dotted;">Date closed </td>
		...
		$url="dcomplaint.php";
		$index=0;
		$rs=@mysql_query("select * from ".$pref."complaint where `uneditable`='92' order by `index` desc");
		if($rs)
		{
			...
			if ($counts>0)
			{
				...
				for($x=$start;$x<$end;$x++)
				{
					...
					echo "
					<tr style=\"background:$color; border-bottom:thin dotted;\"><td valign=\"top\" style=\"border-bottom:thin dotted;\">".($x+1)."</td><td  valign=\"top\" style=\"border-bottom:thin dotted;\">$data[0]</td><td  valign=\"top\" style=\"border-bottom:thin dotted;\">$data[1]</td>
					<td valign=\"top\" style=\"border-bottom:thin dotted;\">$data[29]</td>
					<td valign=\"top\" style=\"border-bottom:thin dotted;\"><a href=\"#\" onclick=\"getPage('ccomplaintdetails.php','content','complaintid=$data[0]&index=$start')\">Details</a>
					</td>
