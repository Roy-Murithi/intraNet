...
<script language="javascript">
	...
	{
		var choice
		choice=confirm("Are you sure you want to delete this function?");
		...
		if($rs)
		{
			...
			if ($counts>0)
			{
				...
				for($x=0;$x<$counts;$x++)
				{
					...
					<td>$filescount</td>
					<td><a href=\"#\" onclick=\"getPage('editfunctions.php','content','functionsid=$data[0]')\">Edit</a> | <a href=\"#\" onclick=\"delPage('functions.php','content','functionsid=$data[0]&del=99')\">Delete</a></td>
					</tr>
					";
				}
			}
