...
<?php
		$script=""; 
		echo classBTN("btnApprove","<img src=\"images/noticeboard.png\" width=\"170\" height=\"99\" style=\"border:none\"  />","../noticeboard","","$script"); 
		?>
      &nbsp;
    ...
    <td valign="top"><div class="parentDiv" id="div">
      <?php
		$script=""; 
		echo classBTN("btnApprove","<img src=\"images/paperlesso.png\" width=\"170\" height=\"99\" style=\"border:none\" />","../boardroom_ipoa","","$script");  
		?>
      &nbsp;
      <div id="div2" class="disp" style="width:210px;">
