...
<table width="644" border="0" cellpadding="0" cellspacing="0" class="PlainContent_Box">
  ...
  <tr>
    <td width="696" height="22" valign="top">Help request to ICT </td>
    <td width="4">&nbsp;</td>
  </tr>
  <tr>
	  ...
	  <table width="100%" border="0" cellpadding="0" cellspacing="1" class="Black_Header_Text"  style="border:thin dotted">
	    ...
	    <tr>
	      <td width="36" height="24" valign="top"><!--DWLayoutEmptyCell-->&nbsp;</td>
            ...
            <td width="71" valign="top">Resolved</td>
            <td width="127" valign="top">Action</td>
          </tr>
		...
		if($rs)
		{
			...
			if ($counts>0)
			{
				...
				for($x=0;$x<$counts;$x++)
				{
					...
					$edit="<a href=\"#\" onclick=\"getPage('processrequest.php','content','supportid=$data[0]')\">View</a>";					
