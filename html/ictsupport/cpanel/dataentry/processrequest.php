...
<table width="705" border="0" cellpadding="0" cellspacing="0" class="Black_Header_Text">
  ...
  <tr>
    ...
    <td colspan="8" valign="top"><span class="style15">Process request for ICT Help </span></td>
    <td width="10"></td>
  </tr>
  <tr>
    <td height="20"></td>
    ...
    <td width="6">&nbsp;</td>
    <td colspan="6" valign="top"><?php echo _getDirectoryUsername(@$datax[1]);?></td>
    <td>&nbsp;</td>
  </tr>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td colspan="6" valign="top"><?php echo @$datax[3]; ?>
  ...
  <tr>
    ...
    <td></td>
    <td colspan="6" rowspan="2" valign="top" style="border:thin dotted;"> <?php 
  ...
  <tr>
    ...
    <td valign="top"><?php 
	$dis2=$dis1="";
		if(@$datax[12]=="99"){ $dis1=" disabled=\"disabled\" ";}
		if(@$datax[12]!=""){ $dis2=" disabled=\"disabled\" ";}
		echo "<input type=\"button\" name=\"edit\" value=\"Mark as unresolved\"  class=\"BTN\" onclick=\"saveUser('0')\" $dis2>";
	?></td>
    <td>&nbsp;</td>
    <td valign="top"><?php
		echo "<input type=\"button\" name=\"edit\" value=\"Mark as resolved\"  class=\"BTN\" onclick=\"saveUser('1')\" $dis1>";
	?>
      <input name="resolved" type="hidden" id="resolved" /></td>
    <td>&nbsp;</td>
    <td valign="top"><input name="Button2" type="button" class="BTN" value="Cancel" style="width:100px;" onclick="getPage('viewrequest.php','content','')"  /></td>
    <td></td>
  </tr>
  <tr>
    <td height="13"></td>
