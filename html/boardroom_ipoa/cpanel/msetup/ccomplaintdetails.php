		...
		for($x=0;$x<sizeof($temp);$x++)
		{
			...
			if($rs1)
			{
				...
				if ($counts1>0)
				{
					...
					{
					$div=$div."<div style=\"float:left;position:relative;\" ><a class=\"flink\" href=\"viewpersons.php?url=dcomplaintdetails&personsid=$datap[0]&complaintid=$datax[0]&sessid=smetsysmocmas&index=$index\"><div id=\"persons\" class=\"persons\" style=\" border: thin solid #7Ba89A; margin-left:20px;margin-top:2px;margin-bottom:2px;  padding-top:3px; padding-bottom:3px; padding-left:10px; padding-right:5px;\">$datap[2]. $datap[3] $datap[4] $datap[5] </div></a></div>";
					}
				}
			}
		}
...
-->
 ...
 <table style="margin-left:15px;"  width="644" border="0" cellpadding="0" cellspacing="0" class="Black_Header_Text">
  ...
  <tr>
    <td height="22" colspan="2" valign="top">Review reffered  complaints </td>
  ...
  <tr>
    <td height="18" colspan="4" valign="top">Reason for closing this complaint </td>
    </tr>
  <tr>
    <td height="54"></td>
    <td colspan="3" valign="top"  style="background-color:#FFCCCC; border: thin solid #FF9999"><?php 	$valDat=fetchValue($pref."explanation","explanationid",@$datax[28],2);echo @$valDat; ?></td>
    </tr>
  <tr>
    <td height="6"></td>
    <td width="373"></td>
  ...
  <tr>
    ...
    <td valign="top"><div align="right">
      <?php
		...
		$script="getPage('return.php','content','complaintid=$datax[0]&sessid=smetsysmocmas&index=$index&pid=ccomplaint&pid1=ccomplaintdetails&uneditableVal=99&rtitle=Re-open closed complaint&complaintfield=Reopen_to_complaints')"; 
		echo classBTN1("btnReturn","Re-open complaint","#","","$script","#FF0000"); 
		?>
    </div></td>
    </tr>
