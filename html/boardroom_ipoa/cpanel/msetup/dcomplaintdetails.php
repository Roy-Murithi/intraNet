...
-->
 ...
 <table style="margin-left:15px;"  width="644" border="0" cellpadding="0" cellspacing="0" class="Black_Header_Text">
  ...
  <tr>
    <td height="18" colspan="4" valign="top">Reason for reffering complaint <?php $strData=fetchValue($pref."reffer","complaintid",$datax[0],3); echo" to $strData";?></td>
    </tr>
  <tr>
    <td height="54"></td>
  ...
  <tr>
    ...
    <td valign="top"><div align="right">
      <?php
		...
		echo classBTN1("btnReturn","Cancel reffer","#","","$script","#FF0000"); 
		?>
    </div></td>
    </tr>
