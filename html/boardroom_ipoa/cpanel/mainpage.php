   ...
   <tr>
	...
	?>
	  ...
	  <div align="left" ><a href="#"  onclick="getPage('users.php','content','')">Users</a></div>
	      ...
	      <div id="mnu0" align="left" class="style4" onclick="expandMNU('0')" >Edit Meetings</div>
	      <div id="mnucont0" style="display:none; margin-left:10px;">
	        <div align="left" class="subf"><a href="#"  onclick="getPage('msetup/meetings.php','content','')">Meetings Category</a></div>
	        <div align="left" class="subf"><a href="#"  onclick="getPage('meetings/schedules.php','content','')">Meetings Schedule</a></div>
		    <div align="left" class="subf"><a href="#"  onclick="getPage('underconstruction.php','content','')">Meeting documents</a></div>
		    <div align="left" class="esubf"><a href="#"  onclick="getPage('meetings/activate.php','content','')">Meeting Activation</a></div>
	      </div>
	      <?php
		  }else
		  {
		  ?>
	  <div align="left" class="HorizontalRuler">&nbsp;</div>
	      <div id="mnu1" align="left" class="style4" onclick="expandMNU('1')">Meeting</div>
	      <div id="mnucont1" style="display:none;  margin-left:10px;">
		      <div align="left" class="subf"><a href="#"  onclick="getPage('meetings/documents.php','content','meetingsid=<?php echo @$_SESSION['meetingsid'];?>')">Documents</a></div>
  <!--		  		<div align="left" class="esubf"><a href="#"  onclick="getPage('underconstruction.php','content','')">Other</a></div>-->
	        </div>
		    <?php
			}
			?>
   ...
   <tr>
     <td height="25" valign="top" class="Black_Header_Text" style="font-size:16px;">Logged in Members </td>
     <td>&nbsp;</td>
   </tr>
   <tr>
     <td height="241" valign="top"><iframe src="usersessions.php?meetingsid=<?php echo  @$_SESSION['meetingsid']?>" style="border:none;" scrolling="no" width="200"> </iframe></td>
     <td>&nbsp;</td>
   </tr>
   <tr>
