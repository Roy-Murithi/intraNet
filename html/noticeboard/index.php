...
<title> IPOA-Notice Board <?php date_default_timezone_set('Africa/Nairobi'); $y = date("Y"); print $y;?> </title>
<LINK REL="SHORTCUT ICON" HREF="http://intranet.ipoa.go.ke/noticeboard/images/Ipoa_favicon.png" />
	    ...
	    <div class="nonclickedBTN" style="float:left;width:585px;">	      
	      ...
	      <div id="index1" class="indexD" align="left">
			...
			}else
			{
				...
				{
					echo "<div class=\"Black_Header_Text\"><b>This page was moved or the link is broken, report this error to ict@ipoa.go.ke</b></div>";
				}
			}
			?>
          </div>	
