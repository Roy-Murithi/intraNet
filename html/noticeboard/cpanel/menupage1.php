...
if(@$_GET['validauth']!="99" && @$_POST['validauth']!="99")
{
...
<br />
<form name="frmSearchm" action="menupage1.php" method="post" enctype="multipart/form-data">
	&nbsp; Page Title <input type="text" name="txtSearch" id="txtSearch" value="" class="STR1"  /><input type="submit" value="Search" class="BTN"  />
    <input name="validauth" type="hidden" id="validauth" value="99" />
</form>
<br />
<?php
	 ...
	 <?php
		...
		if($rs)
		{
			...
			if ($counts>0)
			{
				...
				if($offset>0)
				{
					$First="<a href=\"#\" onclick=\"getPage('menupage1.php','content','index=0&txtSearch=$txtSearch&validauth=99')\"><<</a>";
					if($offset-$maxi<0)
					{
						$prev=0;
					}else
					...
					$Previous="<a href=\"#\" onclick=\"getPage('menupage1.php','content','index=$prev&txtSearch=$txtSearch&validauth=99')\"><</a>";
				}else
				{
					$First="<<";
					$Previous="<";
				...
				{
					$Las=($counts)-$max;
					$Last="<a  href=\"#\" onclick=\"getPage('menupage1.php','content','index=$Las&txtSearch=$txtSearch&validauth=99')\">>></a>";
					
					$nex=$offset+$max;
					$Next="<a href=\"#\" onclick=\"getPage('menupage1.php','content','index=$nex&txtSearch=$txtSearch&validauth=99')\">></a>";
				}else
				{
					$Last=">>";
					$Next=">";
...
<table width="275" border="0" cellpadding="0" cellspacing="0" class="Black_Header_Text">
  <!--DWLayoutTable-->
  <tr>
    <td width="95" height="20" valign="top"><div align="right" class="style15 style14">pages
        <? 
