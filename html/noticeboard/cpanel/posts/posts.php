...
function getJob()
	...
	{
		var choice
		choice=confirm("Are you sure you want to delete this post?");
...
<table width="752" class="Black_Header_Text">
	      <!--DWLayoutTable-->
            <tr>
              <td height="27" colspan="2" valign="top">Posts</td>
              ...
              <td width="209" valign="top"><div align="right"><a href="#" onclick="getPage('editpost.php','content','')">Add new Post </a></div></td>
  <tr>
  ...
  <tr>
		...
		if($rs)
		{
			...
			if ($counts>0)
			{
				...
				if($offset>0)
				{
					$First="<a href=\"#\" onclick=\"getPage('posts.php','content','index=0')\">First</a>";
					if($offset-$maxi<0)
					{
						$prev=0;
					}else
					...
					$Previous="<a href=\"#\" onclick=\"getPage('posts.php','content','index=$prev')\">Previous</a>";
				}else
				{
					$First="First";
					$Previous="Previous";
				...
				{
					$Las=($counts)-$max;
					$Last="<a  href=\"#\" onclick=\"getPage('posts.php','content','index=$Las')\">Last</a>";
					
					$nex=$offset+$max;
					$Next="<a href=\"#\" onclick=\"getPage('posts.php','content','index=$nex')\">Next</a>";
				}else
				{
					$Last="Last";
					$Next="Next";
				...
				{	@mysql_data_seek($rs,$x);
					...
					";
						...
						<div  style=\" width:742px;float:left;\"  align=\"right\">												
							<a href=\"#\" onclick=\"getPage('editpost.php','content','postid=$data[0]')\">Edit</a> | 							<a href=\"#\" onclick=\"delPage('posts.php','content','postid=$data[0]&del=99&index=$offset')\">Delete</a>
						</div>
					</div>				  
				  	</div>
					";
  ...
  <tr>
    <td height="34" colspan="3" valign="top"><div align="right" class="PlainContent_Box">post <? 
