...
<table width="1024" border="0" cellpadding="0" cellspacing="0" style="height:100px;">
  ...
  <tr>
    <td width="218" height="128" valign="top"><span class="Black_Header_Text">
      <?php include "theme/leftsidebar.php"; ?>
    </span></td>
    <td width="11">&nbsp;</td>
    <td width="795" valign="top"><div align="left">
      <?php include "functions/downloads/spec_downloads.php"; ?>
    </div></td>
    </tr>
</table>
<?php
